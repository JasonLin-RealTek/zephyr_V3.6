...
struct espi_reg {
	uint32_t EPSTS;
	const uint32_t EPCFG;
	uint32_t EPINTEN;
	const uint32_t EPRXINFO;
	const uint32_t EPRXADRH;
	const uint32_t EPRXADRL;
	uint32_t EPCPRADR;
	uint32_t EPCPRVLD;
	uint32_t EPBUF;
	uint32_t EPBUFSZ;
	...
	uint32_t EPMRLEN;
	uint32_t EVSTS;
	const uint32_t EVCFG;
	const uint32_t EVIDX2;
	const uint32_t EVIDX3;
	const uint32_t EVIDX7;
	const uint32_t EVIDX41;
	const uint32_t EVIDX42;
	const uint32_t EVIDX43;
	const uint32_t EVIDX44;
	const uint32_t EVIDX47;
	const uint32_t EVIDX4A;
	uint32_t EVTXDAT;
	uint32_t EVPVIDX;
	uint32_t EVRXINTEN;
	uint32_t EVTXINTEN;
	uint32_t EOSTS;
	const uint32_t EOCFG;
	uint32_t EORXINTEN;
	uint32_t EORXBUF;
	uint32_t EORXLEN;
	uint32_t EOTXBUF;
	...
	uint32_t ESBUF;
	uint32_t ESINTEN;
	const uint32_t ESRXADR;
	const uint32_t ESRXLEN;
	uint32_t ESPICFG;
	uint32_t ERSTCFG;
	const uint32_t EVIDX51;
	const uint32_t EVIDX61;
	uint32_t ESRXC;
	uint32_t EFCFG2;
	uint32_t EFCFG3;
	uint32_t EFCFG4;
...
#define ESPI_EPSTS_WR_HOLE  BIT(5)
...
#define ESPI_EPINTEN_WR_HOLE_EN  BIT(3)
...
/* EORXBUF */
#define ESPI_EORXBUF_RXDAT GENMASK(31, 0)

/* EORXLEN */
#define ESPI_EORXLEN_LENGTH GENMASK(11, 0)

/* EOTXBUF */
#define ESPI_EOTXBUF_TXDAT GENMASK(31, 0)
...
#define ESPI_ERSTCFG_CSINTEN BIT(4)
#define ESPI_ERSTCFG_CSSTS   BIT(5)
...
#define ESPI_IOSHORTSTS_TYPE     BIT(2)
#define ESPI_IOSHORTSTS_ACCEPT   BIT(3)
#define ESPI_IOSHORTSTS_RSPSTART BIT(4)
#define ESPI_IOSHORTSTS_RSPRSLT  BIT(5)
